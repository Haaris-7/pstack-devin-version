...
Apply the [Type System Discipline](../poteto-mode/references/principles/type-system-discipline.md) principle first.
...
| Boundary validation | Parse where data crosses in, into a named domain type. `Record<string, unknown>` (however spelled) stops at that parse. Trust types inside. See the [Boundary Discipline](../poteto-mode/references/principles/boundary-discipline.md) principle. |
