...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic. See the [Type System Discipline](../../poteto-mode/references/principles/type-system-discipline.md) and [Boundary Discipline](../../poteto-mode/references/principles/boundary-discipline.md) principles.
...
Validate once where data crosses in. Trust types inside. See the [Boundary Discipline](../../poteto-mode/references/principles/boundary-discipline.md) principle.
