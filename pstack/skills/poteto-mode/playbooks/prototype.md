...
4. When comparing alternatives, build them behind one switcher (buttons or a keypress), each variant labeled. This is the [Exhaust The Design Space](../references/principles/exhaust-the-design-space.md) principle made cheap.
